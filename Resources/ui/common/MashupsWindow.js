function MashupsWindow(title) {
	...
	var data = [
		...
		{title:'CoverFlow', hasChild:true, test:'ui/common/mashups/coverflow'},
		{title:'imagenes remotas', hasChild:true, test:'ui/common/mashups/imag_rem'},
		{title:'Pull Refresh', hasChild:true, test:'ui/common/mashups/pull'},
		{title:'CON DIBUJOS', hasChild:true, test:'ui/common/mashups/dibujos'}
	];
